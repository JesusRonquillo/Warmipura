...
Puedes acceder a nuestros tutoriales en la sección "Warmipura Digital" de nuestra página.`;
    ...
    return '¡Hola! Soy Puma Chaski, tu asistente virtual de Warmipura. Puedo ayudarte con información sobre asesoría legal, nuestros proyectos, ubicación y horarios, o sobre Warmipura Digital. ¿En qué puedo ayudarte?';
  }
