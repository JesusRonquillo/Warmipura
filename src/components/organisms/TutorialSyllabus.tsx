...
import { Play, BookOpen, Clock, CheckCircle, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-digital-base via-white to-digital-base pt-20">
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12 lg:mb-16">
          ...
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-[#FE7F30] mb-4 lg:mb-6">
            Tutorial SUNARP
          </h1>
          ...
          <div className="mt-6 lg:mt-8">
            <Button
              ...
              variant="outline"
              size="lg"
              className="bg-white/80 backdrop-blur-sm border-digital-primary text-digital-primary hover:bg-digital-base hover:border-digital-primary transition-all duration-300"
            >
              ← Volver al Inicio
            </Button>
          </div>
          ...
          {topics.map((topic, index) => (
            <Card
              ...
              className={cn(
                ...
                topic.isActive 
                  ? "border-digital-primary bg-gradient-to-br from-digital-base to-white shadow-xl" 
                  : "border-gray-200 bg-white/80 backdrop-blur-sm hover:border-digital-primary hover:bg-gradient-to-br hover:from-digital-base hover:to-white"
              )}
            ...
            >
              ...
              <div className="relative z-10">
                <div className="flex items-start justify-between mb-4 lg:mb-6">
                  <div className="text-3xl lg:text-4xl group-hover:scale-110 transition-transform duration-300">{topic.icon}</div>
                ...
                <h3 className="text-lg lg:text-xl font-bold text-[#FE7F30] mb-3 lg:mb-4 group-hover:text-[#FE7F30] transition-colors duration-300">
                  {topic.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center text-[#FE7F30] font-semibold text-sm lg:text-base group-hover:text-[#FE7F30] transition-colors duration-300">
        ...
        <div className="text-center mt-12 lg:mt-16">
          <Card variant="outlined" className="p-6 lg:p-8 bg-gradient-to-r from-digital-primary/10 to-digital-base border-digital-primary max-w-2xl mx-auto">
